...
def train_model(train_set, model,Quan,Epoch=300,USE_GPU = True, log_interval =50,patience=20):
    ...
    if Quan:
        savemat(r"./loss_quan.mat", loss)
    else:
        savemat(r"./loss_no_quan.mat", loss)
...
if __name__ == '__main__':  
    ...
    data_name = 'Synthetic_TrainData_bi_decay'
    ckpt_dir='./addernet_pth_for_plot'
